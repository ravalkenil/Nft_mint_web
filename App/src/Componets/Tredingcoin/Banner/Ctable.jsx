import { createTheme, makeStyles, TableHead, ThemeProvider, Typography } from '@material-ui/core'
import axios from 'axios'
import React from 'react'
import {Container ,TextField,TableContainer,LinearProgress,Table,TableCell,TableRow,TableBody} from "@material-ui/core";
...
const Ctable = () => {
    ...
    const handleSerch=()=>{
        ...
        return coin.filter((coin1)=>
            coin1.name.toLowerCase().includes(Search) || coin1.symbol.toLowerCase().includes(Search)
        )
                ...
                <TableContainer>
                    {
                        loading?(
                            ...
                            <Table >
                                ...
                                <TableBody>
                                            {handleSerch().slice((page-1)*10,(page-1)*10+10)
                                            .map((row,i)=>{
                                                ...
                                                console.log(row.id);
                                                const data1=async()=>{
                                                    const {data}= await axios.get(HistoricalChart(row.id,days,currency))
